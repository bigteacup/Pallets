    ...
    public void fullFastSetup() {
        ...
        if (piecesParColis.getText().length() > 0) {
            ...
            if(fast == false) { //fast switch true -> fastMode //fast switch false -> fullMode
              ...
              //  piecesParColis.setNextFocusDownId(findViewById(R.id.fab).getId()); // todo surveiller en cas de requestfocus impossible
    ...
    public void fastMode(){
        ...
        nombrePoidEchantillon = findViewById(R.id.nombrePoidEchantillon);
            ...
            if(fast == false ) {
                ...
                nombreDeColis.setNextFocusDownId(findViewById(R.id.tareColis).getId());
               // piecesParColis.setNextFocusDownId(findViewById(R.id.fab).getId());// correction requestfocus
                piecesParColis.setImeOptions(EditorInfo.IME_ACTION_DONE); // correction requestfocus
